...
export default function ConversaViaMobility() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { id: "m1", text: "Olá, somos da Via Mobility!", fromMe: false },
    { id: "m2", text: "Gostaríamos de agendar uma reunião para discutir possíveis parcerias", fromMe: false },
    { id: "m3", text: "Oi! Claro, tenho interesse", fromMe: true },
    { id: "m4", text: "Que ótimo! Qual seria o melhor horário para vocês?", fromMe: false },
    { id: "m5", text: "Quinta-feira às 14h seria possível?", fromMe: true },
    { id: "m6", text: "Perfeito, vamos agendar então", fromMe: false },
  ]);
