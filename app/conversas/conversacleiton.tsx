...
export default function ConversaCleiton() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { id: "m1", text: "Oi Cleiton, tudo bem?", fromMe: true },
    { id: "m2", text: "Oi! Tudo sim e você?", fromMe: false },
    { id: "m3", text: "Tudo bem! Você terminou aquela parte do backend?", fromMe: true },
    { id: "m4", text: "Terminei sim, já fiz o deploy também", fromMe: false },
    { id: "m5", text: "Nossa, que rápido! Obrigado!", fromMe: true },
    { id: "m6", text: "imagina, obg por perguntar", fromMe: false },
  ]);
