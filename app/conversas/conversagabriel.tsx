...
export default function ConversaGabriel() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { id: "m1", text: "Oi Gabriel, tudo bem?", fromMe: true },
    { id: "m2", text: "Opa, tudo sim e você?", fromMe: false },
    { id: "m3", text: "Beleza! Queria saber se você já começou o projeto", fromMe: true },
    { id: "m4", text: "Sim, já comecei a parte do frontend", fromMe: false },
    { id: "m5", text: "Que legal! Como está indo?", fromMe: true },
    { id: "m6", text: "blzz! Vou ver o que consigo fazer", fromMe: false },
  ]);
